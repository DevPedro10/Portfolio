    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 z-10">
        <div className="text-center space-y-16 max-w-5xl mx-auto">
          {/* Profile Image with imposing effect */}
          <div className="relative mx-auto w-56 h-56 mb-12">
            <div className="absolute inset-0 rounded-full bg-imposing shadow-imposing animate-pulse-slow opacity-20"></div>
            <img
              src={profileImage}
              alt={t.hero.name}
          ...
          <div className="space-y-12">
            <div className="space-y-8">
              <h1 className="text-5xl md:text-8xl font-space font-black leading-tight tracking-tight">
                {t.hero.greeting}{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link to="/projects">
                <Button size="lg" className="imposing-button bg-imposing hover:bg-imposing/90 px-12 py-4 text-base">
                  {t.hero.viewProjects}
                </Button>
              </Link>
              <Link to="/contact">
                <Button variant="outline" size="lg" className="imposing-button imposing-card px-12 py-4 text-base">
                  {t.hero.contact}
                </Button>
              </Link>
            </div>
          ...
          <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2">
            <button
              ...
              className="animate-bounce p-4 rounded-full imposing-card hover:shadow-imposing transition-all duration-300"
