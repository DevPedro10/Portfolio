  ...
  const tests = [
    {
      ...
      description: "Built a responsive product catalog with search, filtering, and cart functionality using React and TypeScript. Implemented advanced state management and optimized performance for large datasets.",
      ...
      codeUrl: "#",
      featured: true,
      challenge: "Create a scalable product catalog that can handle 10,000+ products with real-time search and filtering capabilities."
    },
    {
      id: 2,
      title: "Real-time Chat Application",
      company: "StartupXYZ",
      description: "Developed a real-time chat application with WebSocket integration, user authentication, and message persistence. Focused on creating a smooth user experience with typing indicators and message status.",
      ...
      codeUrl: "#",
      featured: true,
      challenge: "Build a chat app that supports multiple rooms, file sharing, and works seamlessly across different devices."
    },
    {
      id: 3,
      title: "Task Management Dashboard",
      company: "ProductivityCo",
      description: "Created a comprehensive task management system with drag-and-drop functionality, team collaboration features, and detailed analytics dashboard.",
      ...
      codeUrl: "#",
      featured: false,
      challenge: "Design an intuitive interface for managing complex project workflows with multiple team members."
    },
    {
      id: 4,
      title: "API Gateway Microservice",
      company: "CloudTech Inc",
      description: "Implemented a robust API gateway with rate limiting, authentication, and request routing for a microservices architecture.",
      technologies: ["Java", "Spring Cloud Gateway", "Redis", "Docker", "Kubernetes"],
      completedDate: "2023-12-10",
      duration: "6 days",
      demoUrl: "#",
      codeUrl: "#",
      featured: false,
      challenge: "Create a high-performance gateway that can handle 1000+ requests per second with proper error handling."
    },
    {
      id: 5,
      title: "Data Visualization Platform",
      company: "AnalyticsPro",
      description: "Built an interactive data visualization platform with custom charts, real-time updates, and export capabilities for business intelligence.",
      ...
      codeUrl: "#",
      featured: false,
      challenge: "Create dynamic, interactive charts that can process and display large datasets in real-time."
    },
    {
      id: 6,
      title: "Mobile-First PWA",
      company: "MobileTech",
      description: "Developed a Progressive Web App with offline capabilities, push notifications, and native-like performance on mobile devices.",
      technologies: ["React", "PWA", "Service Workers", "IndexedDB", "Web Push API"],
      completedDate: "2023-11-15",
      duration: "4 days",
      demoUrl: "#",
      codeUrl: "#",
      featured: false,
      challenge: "Build a PWA that works seamlessly offline and provides a native app experience."
    }
  ];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherTests.map((test) => (
              <div key={test.id} className="bg-card/50 border border-border/20 rounded-lg p-6 hover:bg-card/70 transition-all duration-300">
                <div className="space-y-4">
                  <div className="space-y-2">
                    <h3 className="text-lg font-space font-semibold">{test.title}</h3>
                    <p className="text-sm text-primary font-medium">{test.company}</p>
                  </div>
