        ...
        <div className="text-center space-y-12 max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button 
                ...
                variant="outline"
                size="lg" 
                className="border-primary/20 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 px-8"
              >
                {t.hero.viewProjects}
              </Button>
              <Button 
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
            <button
              ...
              className="animate-bounce p-3 rounded-full hover:bg-primary/5 transition-colors duration-300"
